...
int main(int argc, char const *argv[]) {
    ...
    vector<int> vector_temp2={};
    TreeNode* node_ptr=new TreeNode(NULL);
    FromArrayToTree(node_ptr,vector_temp);
    TreeNode* node_ptr2=new TreeNode(NULL);
    FromArrayToTree(node_ptr2,vector_temp2);
	int time_point_1=clock();
    auto result=my_solution.mergeTrees(node_ptr,node_ptr2);
